...
export default function SupplierManagementCreateSupplierPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!supplierData.supplierId || !supplierData.name || !supplierData.phoneNumber || !supplierData.email || !supplierData.address || !supplierData.category) {
                        ...
                        <div className="grid gap-6 mb-6 mt-4 lg:grid-cols-1">
                            ...
                            <FormControl fullWidth>
                                ...
                                >
                                    ...
                                    <MenuItem value="Pet Health and Grooming">Pet Health and Grooming</MenuItem>
